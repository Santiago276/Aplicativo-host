      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive" id="letra">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="/Usuario/reservar.php?id=<?php echo $_SESSION["correo_usu"]; ?>">Reserva</a></li> 
          </ul>
          <?php
          ...
          ?>
            <div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="/editarcuenta/editarcuentacli.php">
                  <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>
                  Editar datos</a>
                <a class="dropdown-item" data-toggle="modal" data-toggle="modal" data-target="#exampleModalCenter">
